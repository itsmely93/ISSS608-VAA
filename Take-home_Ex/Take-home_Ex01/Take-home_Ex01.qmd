...
make educationlevel a factor, sort it.
follow the type on the take-home ex instructions

make use dplyr, pivoting. make each category a column for fin_journal (can refer to piazza)
