...
```{r}
pacman::p_load(ggiraph, plotly, patchwork, DT, tidyverse, skimr, knitr, ggstatsplot, ggridges, ggmosaic)
```
...
### 4.1.6 Average earning, spending and savings 

### 4.1.7 Spending, earning, savings by household size, age
...
### Does spending more lead to higher joviality?
